...
#    https://github.com/rdpeng/ProgrammingAssignment2 to create a copy under
#    your own account.
...
# 6. In addition to submitting the URL for your GitHub repository, you will
...
# You will see a list of commits that you have made to this repository. The
...
cacheSolve <- function(x, ...) {
  ...
  if(!is.null(invMatrix)) {
    ...
    message("calculating and caching inverser Matrix")
    data <- x$get()
